========================================================================
    KONSOLENANWENDUNG: GameOfDeath-Projektübersicht
========================================================================

Diese GameOfDeath-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre GameOfDeath-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "GameOfDeath.pch und eine 
