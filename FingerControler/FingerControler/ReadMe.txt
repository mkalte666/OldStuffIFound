========================================================================
    KONSOLENANWENDUNG: FingerControler-Projektübersicht
========================================================================

Diese FingerControler-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre FingerControler-Anwendung besteht.


FingerControler.vcxproj
...
FingerControler.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "FingerControler.pch und eine 
